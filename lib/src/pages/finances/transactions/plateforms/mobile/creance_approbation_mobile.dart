...
class CreanceApprobationMobile extends StatefulWidget {
  const CreanceApprobationMobile(
  ...
  @override
  State<CreanceApprobationMobile> createState() =>
      _CreanceApprobationMobileState();
}

class _CreanceApprobationMobileState extends State<CreanceApprobationMobile> {
  // Approbations
