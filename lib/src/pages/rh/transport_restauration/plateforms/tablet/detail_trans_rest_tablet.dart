...
class DetailTransRestTablet extends StatefulWidget {
  const DetailTransRestTablet(
      {Key? key,
  ...
  @override
  State<DetailTransRestTablet> createState() => _DetailTransRestTabletState();
}

class _DetailTransRestTabletState extends State<DetailTransRestTablet> {
