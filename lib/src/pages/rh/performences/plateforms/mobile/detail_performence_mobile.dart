...
class DetailPerformenceMobile extends StatefulWidget {
  const DetailPerformenceMobile(
      {Key? key,
  ...
  @override
  State<DetailPerformenceMobile> createState() =>
      _DetailPerformenceMobileState();
}

class _DetailPerformenceMobileState extends State<DetailPerformenceMobile> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: SelectableText("$hospitaliteTotal",
          ...
          Row(
            children: [
              ...
              Expanded(
                child: SelectableText("$ponctualiteTotal",
                    textAlign: TextAlign.start, style: headline6),
              ),
            ],
          ),
          Row(
            children: [
              ...
              Expanded(
                child: SelectableText("$travailleTotal",
                    textAlign: TextAlign.start, style: headline6),
              ),
            ],
          ),
