...
class CreanceApprobationTablet extends StatefulWidget {
  const CreanceApprobationTablet(
  ...
  @override
  State<CreanceApprobationTablet> createState() =>
      _CreanceApprobationTabletState();
}

class _CreanceApprobationTabletState extends State<CreanceApprobationTablet> {
  // Approbations
