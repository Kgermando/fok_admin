...
class EntretienApprobationTablet extends StatefulWidget {
  const EntretienApprobationTablet(
  ...
  @override
  State<EntretienApprobationTablet> createState() =>
      _EntretienApprobationTabletState();
}

class _EntretienApprobationTabletState
    extends State<EntretienApprobationTablet> {
  // Approbations
