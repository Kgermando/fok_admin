...
class CampagneApprobationTablet extends StatefulWidget {
  const CampagneApprobationTablet(
      {Key? key,
  ...
  @override
  State<CampagneApprobationTablet> createState() =>
      _CampagneApprobationTabletState();
}

class _CampagneApprobationTabletState extends State<CampagneApprobationTablet> {
