...
class UpdateAgentMobile extends StatefulWidget {
  const UpdateAgentMobile(
      {Key? key,
  ...
  @override
  State<UpdateAgentMobile> createState() => _UpdateAgentMobileState();
}

class _UpdateAgentMobileState extends State<UpdateAgentMobile> {
                      ...
                      child: SizedBox(
                        ...
                        child: ListView(
                          children: [
                            ...
                            dateDebutContratWidget(),
                            const SizedBox(
                              height: p20,
                            ),
                            if (typeContrat == 'CDD') dateFinContratWidget(),
                            const SizedBox(
                              height: p20,
                            ),
                            competanceWidget(),
                            ...
                            BtnWidget(
                                ...
                                press: () {
                                  ...
                                  ScaffoldMessenger.of(context)
                                    ...
                                    content:
                                        const Text("Mis à jour avec succès!"),
