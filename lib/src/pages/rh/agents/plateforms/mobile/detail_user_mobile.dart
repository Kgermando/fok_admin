...
class DetailUserMobile extends StatefulWidget {
  const DetailUserMobile(
  ...
  @override
  State<DetailUserMobile> createState() => _DetailUserMobileState();
}

class _DetailUserMobileState extends State<DetailUserMobile> {
