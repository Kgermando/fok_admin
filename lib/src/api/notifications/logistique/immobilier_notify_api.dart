...
class ImmobilierNotifyApi extends ChangeNotifier {
  var client = http.Client();

  var getDGUrl = Uri.parse("$immobiliersNotifyUrl/get-count-dg/");
  var getDDUrl = Uri.parse("$immobiliersNotifyUrl/get-count-dd/");
