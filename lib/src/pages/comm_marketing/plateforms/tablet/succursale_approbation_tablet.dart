...
class SuccursaleApprobationTablet extends StatefulWidget {
  const SuccursaleApprobationTablet(
  ...
  @override
  State<SuccursaleApprobationTablet> createState() =>
      _SuccursaleApprobationTabletState();
}

class _SuccursaleApprobationTabletState
    extends State<SuccursaleApprobationTablet> {
