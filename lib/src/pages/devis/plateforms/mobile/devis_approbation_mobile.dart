...
class DevisApprobationMobile extends StatefulWidget {
  const DevisApprobationMobile(
      {Key? key,
  ...
  @override
  State<DevisApprobationMobile> createState() => _DevisApprobationMobileState();
}

class _DevisApprobationMobileState extends State<DevisApprobationMobile> {
