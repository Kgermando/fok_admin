...
class ProdModelApprobationMobile extends StatefulWidget {
  const ProdModelApprobationMobile(
  ...
  @override
  State<ProdModelApprobationMobile> createState() =>
      _ProdModelApprobationMobileState();
}

class _ProdModelApprobationMobileState
    extends State<ProdModelApprobationMobile> {
  ...
  Widget build(BuildContext context) {
    return approbationWidget(widget.productModel);
  }
