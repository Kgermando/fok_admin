...
class MobilierApprobationDesktop extends StatefulWidget {
  const MobilierApprobationDesktop(
  ...
  @override
  State<MobilierApprobationDesktop> createState() =>
      _MobilierApprobationDesktopState();
}

class _MobilierApprobationDesktopState
    extends State<MobilierApprobationDesktop> {
  // Approbations
