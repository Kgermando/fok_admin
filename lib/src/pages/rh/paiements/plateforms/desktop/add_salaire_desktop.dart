...
class AddSalaireDestop extends StatefulWidget {
  const AddSalaireDestop(
      {Key? key,
  ...
  @override
  State<AddSalaireDestop> createState() => _AddSalaireDestopState();
}

class _AddSalaireDestopState extends State<AddSalaireDestop> {
