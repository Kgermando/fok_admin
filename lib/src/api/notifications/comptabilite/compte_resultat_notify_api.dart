...
class CompteResultatNotifyApi extends ChangeNotifier {
  var client = http.Client();

  var getDGUrl = Uri.parse("$compteResultatsNotifyUrl/get-count-dg/");
  var getDDUrl = Uri.parse("$compteResultatsNotifyUrl/get-count-dd/");
