...
class AddPerformenceNoteTablet extends StatefulWidget {
  const AddPerformenceNoteTablet(
  ...
  @override
  State<AddPerformenceNoteTablet> createState() =>
      _AddPerformenceNoteTabletState();
}

class _AddPerformenceNoteTabletState extends State<AddPerformenceNoteTablet> {
