...
class ImmobilierApprobationMobile extends StatefulWidget {
  const ImmobilierApprobationMobile(
  ...
  @override
  State<ImmobilierApprobationMobile> createState() =>
      _ImmobilierApprobationMobileState();
}

class _ImmobilierApprobationMobileState
    extends State<ImmobilierApprobationMobile> {
  // Approbations
