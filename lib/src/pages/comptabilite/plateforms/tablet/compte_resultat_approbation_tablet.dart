...
class CompteResultatApprobationTablet extends StatefulWidget {
  const CompteResultatApprobationTablet(
  ...
  @override
  State<CompteResultatApprobationTablet> createState() =>
      _CompteResultatApprobationTabletState();
}

class _CompteResultatApprobationTabletState
    extends State<CompteResultatApprobationTablet> {
