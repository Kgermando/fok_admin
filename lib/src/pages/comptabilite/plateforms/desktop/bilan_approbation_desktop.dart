...
class BilanApprobationDesktop extends StatefulWidget {
  const BilanApprobationDesktop(
      {Key? key, required this.user, required this.bilanModel})
      : super(key: key);
  ...
  @override
  State<BilanApprobationDesktop> createState() =>
      _BilanApprobationDesktopState();
}

class _BilanApprobationDesktopState extends State<BilanApprobationDesktop> {
  ...
  Widget build(BuildContext context) {
    return approbationWidget(widget.bilanModel);
  }
