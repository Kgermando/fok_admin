...
class BalanceApprobationTablet extends StatefulWidget {
  const BalanceApprobationTablet(
  ...
  @override
  State<BalanceApprobationTablet> createState() =>
      _BalanceApprobationTabletState();
}

class _BalanceApprobationTabletState extends State<BalanceApprobationTablet> {
