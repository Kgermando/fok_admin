...
class JournalApprobationMobile extends StatefulWidget {
  const JournalApprobationMobile(
  ...
  @override
  State<JournalApprobationMobile> createState() =>
      _JournalApprobationMobileState();
}

class _JournalApprobationMobileState extends State<JournalApprobationMobile> {
