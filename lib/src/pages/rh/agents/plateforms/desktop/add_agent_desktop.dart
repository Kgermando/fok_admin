...
class AddAgentDesktop extends StatefulWidget {
  const AddAgentDesktop(
      {Key? key,
  ...
  @override
  State<AddAgentDesktop> createState() => _AddAgentDesktopState();
}

class _AddAgentDesktopState extends State<AddAgentDesktop> {
  ...
  void _photeUpload(File file) async {
