...
class JournalApprobationTablet extends StatefulWidget {
  const JournalApprobationTablet(
  ...
  @override
  State<JournalApprobationTablet> createState() =>
      _JournalApprobationTabletState();
}

class _JournalApprobationTabletState extends State<JournalApprobationTablet> {
