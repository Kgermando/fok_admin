...
class BulletinSalaireDesktop extends StatefulWidget {
  const BulletinSalaireDesktop(
      {Key? key,
  ...
  @override
  State<BulletinSalaireDesktop> createState() => _BulletinSalaireDesktopState();
}

class _BulletinSalaireDesktopState extends State<BulletinSalaireDesktop> {
  ...
  Future<void> submitFin(PaiementSalaireModel data) async {
    ...
    await sendEmail(data).then((value) {
      Navigator.pop(context);
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
