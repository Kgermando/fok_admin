...
class ProdModelApprobationDesktop extends StatefulWidget {
  const ProdModelApprobationDesktop(
  ...
  @override
  State<ProdModelApprobationDesktop> createState() =>
      _ProdModelApprobationDesktopState();
}

class _ProdModelApprobationDesktopState
    extends State<ProdModelApprobationDesktop> {
