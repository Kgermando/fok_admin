...
class CarburantApprobationMobile extends StatefulWidget {
  const CarburantApprobationMobile(
  ...
  @override
  State<CarburantApprobationMobile> createState() =>
      _CarburantApprobationMobileState();
}

class _CarburantApprobationMobileState
    extends State<CarburantApprobationMobile> {
  // Approbations
