...
class DetailAgentTablet extends StatefulWidget {
  const DetailAgentTablet(
      {Key? key,
  ...
  @override
  State<DetailAgentTablet> createState() => _DetailAgentTabletState();
}

class _DetailAgentTabletState extends State<DetailAgentTablet> {
