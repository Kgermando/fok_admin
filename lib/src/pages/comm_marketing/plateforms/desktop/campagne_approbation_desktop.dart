...
class CampagneApprobationDesktop extends StatefulWidget {
  const CampagneApprobationDesktop(
      {Key? key,
  ...
  @override
  State<CampagneApprobationDesktop> createState() =>
      _CampagneApprobationDesktopState();
}

class _CampagneApprobationDesktopState
    extends State<CampagneApprobationDesktop> {
  ...
  Widget build(BuildContext context) {
    return approbationWidget(widget.campaignModel);
  }
    ...
    for (var i in widget.departementsList) {
      dataList = widget.ligneBudgetaireList
          .where((element) =>
              ...
              element.departement == "Commercial et Marketing")
  ...
  Future<void> submitDG(CampaignModel data) async {
    final campaignModel = CampaignModel(
        id: data.id!,
  ...
  Future<void> submitDD(CampaignModel data) async {
    final campaignModel = CampaignModel(
        id: data.id!,
        typeProduit: data.typeProduit,
        dateDebutEtFin: data.dateDebutEtFin,
  ...
  Future<void> submitBudget(CampaignModel data) async {
    final campaignModel = CampaignModel(
        id: data.id!,
        typeProduit: data.typeProduit,
        dateDebutEtFin: data.dateDebutEtFin,
