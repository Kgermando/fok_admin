...
class TrajetApprobationMobile extends StatefulWidget {
  const TrajetApprobationMobile(
  ...
  @override
  State<TrajetApprobationMobile> createState() =>
      _TrajetApprobationMobileState();
}

class _TrajetApprobationMobileState extends State<TrajetApprobationMobile> {
  // Approbations
