...
class AddPerformenceNoteMobile extends StatefulWidget {
  const AddPerformenceNoteMobile(
  ...
  @override
  State<AddPerformenceNoteMobile> createState() =>
      _AddPerformenceNoteMobileState();
}

class _AddPerformenceNoteMobileState extends State<AddPerformenceNoteMobile> {
