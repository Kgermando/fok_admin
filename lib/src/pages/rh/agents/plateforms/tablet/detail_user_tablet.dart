...
class DetailUserTablet extends StatefulWidget {
  const DetailUserTablet(
  ...
  @override
  State<DetailUserTablet> createState() => _DetailUserTabletState();
}

class _DetailUserTabletState extends State<DetailUserTablet> {
