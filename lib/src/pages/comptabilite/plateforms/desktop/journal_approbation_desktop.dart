...
class JournalApprobationDesktop extends StatefulWidget {
  const JournalApprobationDesktop(
      {Key? key, required this.user, required this.journalLivreModel})
      : super(key: key);
  ...
  @override
  State<JournalApprobationDesktop> createState() =>
      _JournalApprobationDesktopState();
}

class _JournalApprobationDesktopState extends State<JournalApprobationDesktop> {
  ...
  Widget build(BuildContext context) {
    return approbationWidget(widget.journalLivreModel);
  }

  Widget approbationWidget(JournalLivreModel data) {
  ...
  Widget approbationDGWidget(JournalLivreModel data) {
  ...
  Widget motifDGWidget(JournalLivreModel data) {
    return Container(
        margin: const EdgeInsets.only(bottom: p10),
        child: Row(
          children: [
  ...
  Widget approbationDDWidget(JournalLivreModel data) {
    List<String> approbationList = ['Approved', 'Unapproved', '-'];
    return Container(
      margin: const EdgeInsets.only(bottom: p10),
      child: DropdownButtonFormField<String>(
  ...
  Widget motifDDWidget(JournalLivreModel data) {
    return Container(
        margin: const EdgeInsets.only(bottom: p10),
        child: Row(
          children: [
  ...
  Future<void> submitDG(JournalLivreModel data) async {
    final journal = JournalLivreModel(
    ...
    await JournalLivreApi().updateData(journal).then((value) {
  ...
  Future<void> submitDD(JournalLivreModel data) async {
    final journal = JournalLivreModel(
        intitule: data.intitule,
        debut: data.debut,
        fin: data.fin,
