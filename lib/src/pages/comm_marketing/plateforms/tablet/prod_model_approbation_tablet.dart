...
class ProdModelApprobationTablet extends StatefulWidget {
  const ProdModelApprobationTablet(
  ...
  @override
  State<ProdModelApprobationTablet> createState() =>
      _ProdModelApprobationTabletState();
}

class _ProdModelApprobationTabletState
    extends State<ProdModelApprobationTablet> {
