...
class UpdateEtatMateriel extends StatefulWidget {
  const UpdateEtatMateriel({Key? key, required this.etatMaterielModel})
      : super(key: key);
...
class _UpdateEtatMaterielState extends State<UpdateEtatMateriel> {
  ...
  Future<void> submit() async {
    final etatMaterielModel = EtatMaterielModel(
        id: widget.etatMaterielModel.id,
        nom: nom.toString(),
        modele: widget.etatMaterielModel.modele,
        marque: widget.etatMaterielModel.marque,
