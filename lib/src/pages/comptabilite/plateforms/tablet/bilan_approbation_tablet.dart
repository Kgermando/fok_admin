...
class BilanApprobationTablet extends StatefulWidget {
  const BilanApprobationTablet(
  ...
  @override
  State<BilanApprobationTablet> createState() => _BilanApprobationTabletState();
}

class _BilanApprobationTabletState extends State<BilanApprobationTablet> {
