...
class DetailPresenceDesktop extends StatefulWidget {
  const DetailPresenceDesktop(
      {Key? key,
  ...
  @override
  State<DetailPresenceDesktop> createState() => _DetailPresenceDesktopState();
}

class _DetailPresenceDesktopState extends State<DetailPresenceDesktop> {
