...
const UpdateAgentDesktop(
  ...
  @override
  State<UpdateAgentDesktop> createState() => _UpdateAgentDesktopState();
}

class _UpdateAgentDesktopState extends State<UpdateAgentDesktop> {
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: ClipOval(
                                      child: (widget.agentModel.photo == null)
                                          ? Image.asset(
