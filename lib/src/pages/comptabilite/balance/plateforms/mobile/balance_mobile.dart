...
class BalanceMobile extends StatefulWidget {
  const BalanceMobile(
      {Key? key,
      required this.user,
  ...
  @override
  State<BalanceMobile> createState() => _BalanceMobileState();
}

class _BalanceMobileState extends State<BalanceMobile> {
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(flex: 3, child: Text(data.title, style: bodySmall))
            ],
          ),
            ...
            return SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  var codeCompte = compte.comptes.split('_');
