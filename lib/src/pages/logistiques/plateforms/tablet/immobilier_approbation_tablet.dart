...
class ImmobilierApprobationTablet extends StatefulWidget {
  const ImmobilierApprobationTablet(
  ...
  @override
  State<ImmobilierApprobationTablet> createState() =>
      _ImmobilierApprobationTabletState();
}

class _ImmobilierApprobationTabletState
    extends State<ImmobilierApprobationTablet> {
  // Approbations
