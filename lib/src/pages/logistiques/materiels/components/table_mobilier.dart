...
import 'package:fokad_admin/src/pages/logistiques/materiels/components/mobilier_xlsx.dart';
...
class TableMobilier extends StatefulWidget {
  const TableMobilier({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return PlutoGrid(
      ...
      onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) {
        ...
        Navigator.pushNamed(context, LogistiqueRoutes.logMobilierMaterielDetail,
            ...
            Row(
              children: [
                ...
                PrintWidget(onPressed: () {
                  MobilierXlsx().exportToExcel(dataList);
                  if (!mounted) return;
