...
class CreanceApprobationDesktop extends StatefulWidget {
  const CreanceApprobationDesktop(
      {Key? key, required this.creanceModel, required this.user})
      : super(key: key);
  final CreanceModel creanceModel;
  final UserModel user;

  @override
  State<CreanceApprobationDesktop> createState() =>
      _CreanceApprobationDesktopState();
}

class _CreanceApprobationDesktopState extends State<CreanceApprobationDesktop> {
  // Approbations
  ...
  Widget build(BuildContext context) {
    return approbationWidget(widget.creanceModel);
  }
  ...
  Widget approbationDGWidget(CreanceModel data) {
  ...
  Widget motifDGWidget(CreanceModel data) {
    return Container(
        margin: const EdgeInsets.only(bottom: p20),
        child: Row(
          children: [
  ...
  Widget approbationDDWidget(CreanceModel data) {
    List<String> approbationList = ['Approved', 'Unapproved', '-'];
    return Container(
      margin: const EdgeInsets.only(bottom: p20),
      child: DropdownButtonFormField<String>(
  ...
  Widget motifDDWidget(CreanceModel data) {
    return Container(
        margin: const EdgeInsets.only(bottom: p20),
        child: Row(
          children: [
  ...
  Future<void> submitDD(CreanceModel data) async {
    final creanceModel = CreanceModel(
        id: data.id!,
        nomComplet: data.nomComplet,
        pieceJustificative: data.pieceJustificative,
