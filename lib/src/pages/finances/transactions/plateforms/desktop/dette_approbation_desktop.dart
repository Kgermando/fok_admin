...
class DetteApprobationDesktop extends StatefulWidget {
  const DetteApprobationDesktop(
  ...
  @override
  State<DetteApprobationDesktop> createState() =>
      _DetteApprobationDesktopState();
}

class _DetteApprobationDesktopState extends State<DetteApprobationDesktop> {
  // Approbations
