...
class DevisApprobationDesktop extends StatefulWidget {
  const DevisApprobationDesktop(
      {Key? key,
  ...
  @override
  State<DevisApprobationDesktop> createState() =>
      _DevisApprobationDesktopState();
}

class _DevisApprobationDesktopState extends State<DevisApprobationDesktop> {
