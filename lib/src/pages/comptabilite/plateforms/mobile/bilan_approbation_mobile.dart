...
class BilanApprobationMobile extends StatefulWidget {
  const BilanApprobationMobile(
  ...
  @override
  State<BilanApprobationMobile> createState() => _BilanApprobationMobileState();
}

class _BilanApprobationMobileState extends State<BilanApprobationMobile> {
