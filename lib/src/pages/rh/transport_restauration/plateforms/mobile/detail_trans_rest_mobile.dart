...
class DetailTransRestMobile extends StatefulWidget {
  const DetailTransRestMobile(
      {Key? key,
  ...
  @override
  State<DetailTransRestMobile> createState() => _DetailTransRestMobileState();
}

class _DetailTransRestMobileState extends State<DetailTransRestMobile> {
  ...
  TableRow tableRowHeader(TransportRestaurationModel data) {
    return TableRow(children: [
      ...
      Container(
        ...
        width: 200,
        child:
            AutoSizeText((data.approbationDD == "Approved") ? "" : "Retirer"),
      ),
    ]);
  }
