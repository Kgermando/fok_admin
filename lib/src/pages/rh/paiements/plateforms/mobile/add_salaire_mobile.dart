...
class AddSalaireMobile extends StatefulWidget {
  const AddSalaireMobile(
      {Key? key,
  ...
  @override
  State<AddSalaireMobile> createState() => _AddSalaireMobileState();
}

class _AddSalaireMobileState extends State<AddSalaireMobile> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: tauxJourHeureMoisSalaireWidget()),
            ],
          ),
          Row(
            children: [
              Expanded(child: joursHeuresPayeA100PourecentSalaireWidget()),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: nombreHeureSupplementairesWidget()),
            ],
          ),
          Row(
            children: [
              Expanded(child: tauxHeureSupplementairesWidget()),
              Expanded(child: totalDuHeureSupplementairesWidget())
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: primeFielWidget()),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: diversFielWidget()),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: joursCongesPayeWidget()),
            ],
          ),
          Row(
            children: [
              Expanded(child: tauxCongesPayeWidget()),
              Expanded(child: totalDuCongesPayeWidget()),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: jourPayeMaladieAccidentWidget()),
            ],
          ),
          Row(
            children: [
          ...
          Row(
            children: [
              Expanded(child: tauxJournalierMaladieAccidentWidget()),
              Expanded(child: totalDuMaladieAccidentWidget())
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: totalDuBrutFieldWidget()),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: indemniteCompensatricesDeductionWidget()),
            ],
          ),
          Row(
            children: [
          ...
          Row(
            children: [Expanded(child: retenuesFiscalesDeductionWidget())],
          ),
        ],
      ),
    );
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(
                  child: nombreEnfantBeneficaireAllocationsFamilialesWidget()),
            ],
          ),
          Row(
            children: [
              Expanded(child: nombreDeJoursAllocationsFamilialesWidget()),
            ],
          ),
          Row(
            children: [
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: netAPayerFieldWidget()),
            ],
          ),
        ],
      ),
