...
class UpdateAnnuaire extends StatefulWidget {
  const UpdateAnnuaire({Key? key, required this.annuaireColor})
      : super(key: key);
...
class _UpdateAnnuaireState extends State<UpdateAnnuaire> {
  ...
  void initState() {
    getData();
    categorie = widget.annuaireColor.annuaireModel.categorie;
    nomPostnomPrenomController = TextEditingController(
        text: widget.annuaireColor.annuaireModel.nomPostnomPrenom);
    emailController =
        TextEditingController(text: widget.annuaireColor.annuaireModel.email);
    mobile1Controller =
        TextEditingController(text: widget.annuaireColor.annuaireModel.mobile1);
    mobile2Controller =
        TextEditingController(text: widget.annuaireColor.annuaireModel.mobile2);
    secteurActiviteController = TextEditingController(
        text: widget.annuaireColor.annuaireModel.secteurActivite);
    nomEntrepriseController = TextEditingController(
        text: widget.annuaireColor.annuaireModel.nomEntreprise);
    gradeController =
        TextEditingController(text: widget.annuaireColor.annuaireModel.grade);
    adresseEntrepriseController = TextEditingController(
        text: widget.annuaireColor.annuaireModel.adresseEntreprise);
    super.initState();
  }
  ...
  Future<void> submit() async {
    final annuaireModel = AnnuaireModel(
        id: widget.annuaireColor.annuaireModel.id,
    ...
    await AnnuaireApi().updateData(annuaireModel).then((value) {
