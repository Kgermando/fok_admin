...
class MobilierApprobationTablet extends StatefulWidget {
  const MobilierApprobationTablet(
  ...
  @override
  State<MobilierApprobationTablet> createState() =>
      _MobilierApprobationTabletState();
}

class _MobilierApprobationTabletState extends State<MobilierApprobationTablet> {
  // Approbations
