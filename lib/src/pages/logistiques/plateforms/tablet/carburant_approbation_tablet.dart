...
class CarburantApprobationTablet extends StatefulWidget {
  const CarburantApprobationTablet(
  ...
  @override
  State<CarburantApprobationTablet> createState() =>
      _CarburantApprobationTabletState();
}

class _CarburantApprobationTabletState
    extends State<CarburantApprobationTablet> {
  // Approbations
