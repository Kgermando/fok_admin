...
class EtatMaterielApprobationDesktop extends StatefulWidget {
  const EtatMaterielApprobationDesktop(
  ...
  @override
  State<EtatMaterielApprobationDesktop> createState() =>
      _EtatMaterielApprobationDesktopState();
}

class _EtatMaterielApprobationDesktopState
    extends State<EtatMaterielApprobationDesktop> {
  // Approbations
