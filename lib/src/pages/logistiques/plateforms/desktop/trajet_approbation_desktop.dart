...
class TrajetApprobationDesktop extends StatefulWidget {
  const TrajetApprobationDesktop(
  ...
  @override
  State<TrajetApprobationDesktop> createState() =>
      _TrajetApprobationDesktopState();
}

class _TrajetApprobationDesktopState extends State<TrajetApprobationDesktop> {
  // Approbations
