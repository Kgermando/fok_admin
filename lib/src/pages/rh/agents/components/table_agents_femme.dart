...
class TableAgentsFemme extends StatefulWidget {
  const TableAgentsFemme({Key? key}) : super(key: key);

  @override
  State<TableAgentsFemme> createState() => _TableAgentsFemmeState();
}

class _TableAgentsFemmeState extends State<TableAgentsFemme> {
  ...
  Future agentsRow() async {
    ...
    var data =
        agents.where((element) => element!.sexe == 'Femme').toList();
    if (mounted) {
      setState(() {
