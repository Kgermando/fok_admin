...
class ImmobilierApprobationDesktop extends StatefulWidget {
  const ImmobilierApprobationDesktop(
      {Key? key, required this.immobilierModel, required this.user})
      : super(key: key);
  final ImmobilierModel immobilierModel;
  final UserModel user;

  @override
  State<ImmobilierApprobationDesktop> createState() =>
      _ImmobilierApprobationDesktopState();
}

class _ImmobilierApprobationDesktopState
    extends State<ImmobilierApprobationDesktop> {
  // Approbations
  ...
  Widget build(BuildContext context) {
    return approbationWidget(widget.immobilierModel);
  }
  ...
  Widget approbationDGWidget(ImmobilierModel data) {
  ...
  Widget motifDGWidget(ImmobilierModel data) {
    return Container(
        margin: const EdgeInsets.only(bottom: p20),
        child: Row(
          children: [
  ...
  Widget approbationDDWidget(ImmobilierModel data) {
    List<String> approbationList = ['Approved', 'Unapproved', '-'];
    return Container(
      margin: const EdgeInsets.only(bottom: p20),
      child: DropdownButtonFormField<String>(
  ...
  Widget motifDDWidget(ImmobilierModel data) {
    return Container(
        margin: const EdgeInsets.only(bottom: p20),
        child: Row(
          children: [
  ...
  Future<void> submitDD(ImmobilierModel data) async {
    final immobilierModel = ImmobilierModel(
        id: data.id!,
        typeAllocation: data.typeAllocation,
        adresse: data.adresse,
