...
class CampagneApprobationMobile extends StatefulWidget {
  const CampagneApprobationMobile(
      {Key? key,
  ...
  @override
  State<CampagneApprobationMobile> createState() =>
      _CampagneApprobationMobileState();
}

class _CampagneApprobationMobileState extends State<CampagneApprobationMobile> {
