...
class EntretienApprobationMobile extends StatefulWidget {
  const EntretienApprobationMobile(
  ...
  @override
  State<EntretienApprobationMobile> createState() =>
      _EntretienApprobationMobileState();
}

class _EntretienApprobationMobileState
    extends State<EntretienApprobationMobile> {
  // Approbations
