...
class CompteResultatApprobationMobile extends StatefulWidget {
  const CompteResultatApprobationMobile(
  ...
  @override
  State<CompteResultatApprobationMobile> createState() =>
      _CompteResultatApprobationMobileState();
}

class _CompteResultatApprobationMobileState
    extends State<CompteResultatApprobationMobile> {
