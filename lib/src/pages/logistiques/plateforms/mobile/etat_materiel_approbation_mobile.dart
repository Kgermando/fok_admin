...
class EtatMaterielApprobationMobile extends StatefulWidget {
  const EtatMaterielApprobationMobile(
  ...
  @override
  State<EtatMaterielApprobationMobile> createState() =>
      _EtatMaterielApprobationMobileState();
}

class _EtatMaterielApprobationMobileState
    extends State<EtatMaterielApprobationMobile> {
  // Approbations
