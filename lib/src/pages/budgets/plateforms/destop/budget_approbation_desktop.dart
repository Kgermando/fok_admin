...
class BudgetApprobationDesktop extends StatefulWidget {
  const BudgetApprobationDesktop(
  ...
  @override
  State<BudgetApprobationDesktop> createState() =>
      _BudgetApprobationDesktopState();
}

class _BudgetApprobationDesktopState extends State<BudgetApprobationDesktop> {
  // Approbations
