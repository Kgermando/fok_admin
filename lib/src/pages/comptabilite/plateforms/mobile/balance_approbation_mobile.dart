...
class BalanceApprobationMobile extends StatefulWidget {
  const BalanceApprobationMobile(
  ...
  @override
  State<BalanceApprobationMobile> createState() =>
      _BalanceApprobationMobileState();
}

class _BalanceApprobationMobileState extends State<BalanceApprobationMobile> {
