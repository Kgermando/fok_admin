...
class EnginApprobationTablet extends StatefulWidget {
  const EnginApprobationTablet(
  ...
  @override
  State<EnginApprobationTablet> createState() => _EnginApprobationTabletState();
}

class _EnginApprobationTabletState extends State<EnginApprobationTablet> {
  // Approbations
