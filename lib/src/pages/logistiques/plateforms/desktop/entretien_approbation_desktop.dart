...
class EntretienApprobationDesktop extends StatefulWidget {
  const EntretienApprobationDesktop(
      {Key? key, required this.entretienModel, required this.user})
      : super(key: key);
  final EntretienModel entretienModel;
  final UserModel user;

  @override
  State<EntretienApprobationDesktop> createState() =>
      _EntretienApprobationDesktopState();
}

class _EntretienApprobationDesktopState
    extends State<EntretienApprobationDesktop> {
  // Approbations
  ...
  Widget build(BuildContext context) {
    return approbationWidget(widget.entretienModel);
  }
