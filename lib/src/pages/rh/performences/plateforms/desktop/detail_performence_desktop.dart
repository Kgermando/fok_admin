...
class DetailPerformenceDesktop extends StatefulWidget {
  const DetailPerformenceDesktop(
      {Key? key,
  ...
  @override
  State<DetailPerformenceDesktop> createState() =>
      _DetailPerformenceDesktopState();
}

class _DetailPerformenceDesktopState extends State<DetailPerformenceDesktop> {
  ...
  Future<List<PerformenceNoteModel>> getDataFuture() async {
