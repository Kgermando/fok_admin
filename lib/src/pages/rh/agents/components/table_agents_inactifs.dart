...
class TableAgentsInactif extends StatefulWidget {
  const TableAgentsInactif({Key? key}) : super(key: key);

  @override
  State<TableAgentsInactif> createState() => _TableAgentsInactifState();
}

class _TableAgentsInactifState extends State<TableAgentsInactif> {
  ...
  Future agentsRow() async {
    ...
    var data =
        agents.where((element) => element!.statutAgent == 'false').toList();
    if (mounted) {
      setState(() {
