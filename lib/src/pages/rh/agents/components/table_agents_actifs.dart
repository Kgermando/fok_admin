...
class TableAgentsActif extends StatefulWidget {
  const TableAgentsActif({Key? key}) : super(key: key);

  @override
  State<TableAgentsActif> createState() => _TableAgentsActifState();
}

class _TableAgentsActifState extends State<TableAgentsActif> {
  ...
  Future agentsRow() async {
    ...
    var data =
        agents.where((element) => element!.statutAgent == 'true').toList();
    if (mounted) {
      setState(() {
