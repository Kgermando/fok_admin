...
class SuccursaleApprobationDesktop extends StatefulWidget {
  const SuccursaleApprobationDesktop(
  ...
  @override
  State<SuccursaleApprobationDesktop> createState() =>
      _SuccursaleApprobationDesktopState();
}

class _SuccursaleApprobationDesktopState
    extends State<SuccursaleApprobationDesktop> {
