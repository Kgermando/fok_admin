...
class CarburantApprobationDesktop extends StatefulWidget {
  const CarburantApprobationDesktop(
      {Key? key, required this.carburantModel, required this.user})
      : super(key: key);
  final CarburantModel carburantModel;
  final UserModel user;

  @override
  State<CarburantApprobationDesktop> createState() =>
      _CarburantApprobationDesktopState();
}

class _CarburantApprobationDesktopState
    extends State<CarburantApprobationDesktop> {
  // Approbations
  ...
  Widget build(BuildContext context) {
    return approbationWidget(widget.carburantModel);
  }
  ...
  Future<void> submitDD(CarburantModel data) async {
    ...
    await CarburantApi().updateData(carburantModel).then((value) {
