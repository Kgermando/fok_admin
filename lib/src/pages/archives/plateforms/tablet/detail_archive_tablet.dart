...
class DetailArchiveTablet extends StatefulWidget {
  const DetailArchiveTablet(
  ...
  @override
  State<DetailArchiveTablet> createState() => _DetailArchiveTabletState();
}

class _DetailArchiveTabletState extends State<DetailArchiveTablet> {
  @override
